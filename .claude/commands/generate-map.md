...
1. Read `_skill/SKILL_cohort_teaching_map.md` for the full teaching map generation process and format.
...
4. Check if `classes/<class-name>/teaching-map.md` already exists.
   ...
   - If it doesn't exist, ask the teacher to paste or describe the chapter list, syllabus, or unit breakdown.
...
5. Generate the full cohort teaching map following the skill definition, incorporating:
   ...
   - The chapter/unit list provided by the teacher
